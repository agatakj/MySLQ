...
/* Question 2 Find customers from Spain and Switzerland who have not placed any orders. Retrieve customer name, number, and country as shown in screenshot below. Sort by customer name in ascending order. 
